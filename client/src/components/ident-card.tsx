...
export function IdentCard({ ident }: { ident: string | undefined }) {
  function copyIdent() {
    if (ident) {
      ...
      toast({ title: "Ident code copied!", duration: 2000 });
    }
  }
    ...
    <Card className="w-full max-w-lg">
      <CardHeader>
        <div className="flex items-center space-x-2">
          ...
          <CardTitle className="text-2xl">Your connection code</CardTitle>
        </div>
        <p className="text-sm text-muted-foreground">
          Give this code to another person to connect with you.
        </p>
      </CardHeader>
